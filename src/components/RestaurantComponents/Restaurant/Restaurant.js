        ...
        <div className='col-lg-3 col-sm-4 col-12' onClick={() => navigate(`/restaurant/${id}`)} style={{ cursor: "pointer" }}>
            <div className='Restaurant_card'>
                ...
                <div className='Restaurant_card_title'>
                    <h5>{name}</h5>
                    <h5><i className="fas fa-star me-2" style={{ color: "rgb(253, 197, 14)" }}></i>{rating}/5 <span className="second_title">(12k)</span></h5>
                </div>
                <p className='mt-2 mb-0 p-0 second_title'>{average_cost}</p>
                <hr />
                <div className='d-flex justify-content-between'>
                    <p className="brand_color"><i className="far fa-heart me-2"></i> 12</p>
                    <p>{tk}<span> tk</span> <span className="second_title">{fee}</span></p>
                </div>
            </div>
        </div>
    );
